...
{!! Form::close() !!}
	...
	<table class="table table-striped">
		...
		?>
			...
			@endif
			@if($servicio->status <> '7' and  $dif2 < 172800 and $dif2 > 1)<!-- Orden no entregada y en menos de 2 dias NARANJA-->
			...
			<td>{!!link_to_route('tecnico.edit', $title = 'Editar', $parameters = $servicio->id, $attributes = ['class'=>'btn btn-info btn-lg btn-block'])!!}</td>
		</tbody>
			@endforeach
	</table>
{!!$servicios->render()!!}
