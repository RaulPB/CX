                 ...
                 <table  WIDTH="100%" class="display" style="text-align:center;"   border-collapse: separate;>
                     ...
                     @foreach($correo as $datos)
                         <tr>
                          ...
                          <td colspan="30" style="text-align: center;">{{date('d-m-Y', strtotime($datos->actualiza))}}</td>
 ...
 >
                     ...
                     @foreach($correo2 as $datos2)
                         <tr>
                          ...
                          <td colspan="30" style="text-align: justify;">{{date('d-m-Y', strtotime($datos2->actualizada))}}</td>
                   ...
                   <br><br>
                    <H3> Total Global: {{number_format($totalfinal2,2)}}  </H3>
               </div>
